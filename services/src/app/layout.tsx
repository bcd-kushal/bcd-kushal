...
import favicon from "@/app/kushalkumar_bg_light.ico"

const inter = Outfit({ subsets: ["latin"] })

export const metadata: Metadata = {
    title: "Kushal Kumar Saha: Services",
    description: "Kushal Kumar Saha services in one place to reach out",
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
    return (
        <html lang="en" suppressHydrationWarning>
            <head><link href={favicon.src} rel="icon"/></head>
                    ...
                    <section className={styles.rcm}>
                        ...
                        <div className="rcm-about-me">
                            ...
                            <div className="rcm-am-desc">
                                ...
                                industry-ready seamless alluring softwares solutions. If you need any software created/managed 
                                or website done, especially UI-focused, look no further.
                            </div>
                        </div>
                    </section>
                </main>
